  ...
  return (
    <article className={`message ${msg.role}`}>
      ...
      <div className="message-wrap">
        <span className="message-meta">{isBot ? 'StudyBot' : 'You'}</span>
...
function TypingIndicator() {
  return (
    <article className="message assistant">
      ...
      <div className="message-wrap">
        <span className="message-meta">StudyBot</span>
    ...
    <div className="chat-app">
      ...
      <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <div className="sidebar-bottom">
          <p className="sidebar-footer-text">StudyBot · Gemini AI powered</p>
        </div>
      </aside>
          ...
          <div className="composer-wrap">
            ...
            <div className="composer">
              <textarea
                ...
                value={input}
                rows={1}
                placeholder="Message StudyBot… (Shift+Enter for new line)"
                disabled={isSending}
            ...
            <div className="composer-footer">
              <span className="disclaimer">StudyBot may make mistakes · Always verify important information</span>
            </div>
          </div>
        </footer>
      </div>
